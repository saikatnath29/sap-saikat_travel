...
@EndUserText.label: 'Travel_root_entity'
...
define root view entity ZI_TRAVEL_SAIK_M
  as select from ztravel_saik_m
  composition [0..*] of ZI_BOOKING_SAI_M         as _Booking
